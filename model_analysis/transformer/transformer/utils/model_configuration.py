...
def compute_metrics(p):
    ...
    recall_score = recall.compute(predictions=preds, references=labels, average="binary")
    precision_score = precision.compute(predictions=preds, references=labels, average="binary")
