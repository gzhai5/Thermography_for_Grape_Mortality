...
do
    ...
    do
        python lstm_nofeatures.py --data $data --seed $seed
        python lstm_features.py --data $data --seed $seed
        python lstmfcn_nofeatures.py --data $data --seed $seed
        python lstmfcn_features.py --data $data --seed $seed
    done
done