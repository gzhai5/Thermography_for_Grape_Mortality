...
# Load your data
data <- read.csv("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/statistics/csv/stat_all_data_noabnormal_extend_mean_normalization_pca_round_2.csv")
...
# ---- Development Stage 2 ----
cat("Running Gamma model for Development Stage 2...\n")
stage_2_data <- data[data$dev_stage == "2", ]

# Apply filtering to exclude specified conditions
stage_2_data <- stage_2_data[!(stage_2_data$treatment == 1 & stage_2_data$mortality == "false") &
                       !(stage_2_data$treatment == 2 & stage_2_data$mortality == "true"), ]
...
ggsave("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/paper/glme/glme_exp1.svg", 
