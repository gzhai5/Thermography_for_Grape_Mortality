...
# Load your data
data <- read.csv("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/statistics/csv/stat_all_data_noabnormal_extend_mean_normalization_pca_round_3.csv")
...
# ---- Development Stage 3 ----
cat("Running Gamma model for Development Stage 3...\n")
stage_3_data <- data[data$dev_stage == "3", ]

# Apply filtering to exclude specified conditions
stage_3_data <- stage_3_data[!(stage_3_data$treatment == 1 & stage_3_data$mortality == "false") &
                       !(stage_3_data$treatment == 2 & stage_3_data$mortality == "true"), ]
...
ggsave("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/paper/glme/glme_exp2.svg", 
