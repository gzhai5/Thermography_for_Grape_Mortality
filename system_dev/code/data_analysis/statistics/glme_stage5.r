...
# Load your data
data <- read.csv("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/statistics/csv/stat_all_data_noabnormal_extend_mean_normalization_pca_round_5.csv")
...
# ---- Development Stage 5 ----
cat("Running Gamma model for Development Stage 5...\n")
stage_5_data <- data[data$dev_stage == "5", ]

# Apply filtering to exclude specified conditions
stage_5_data <- stage_5_data[!(stage_5_data$treatment == 1 & stage_5_data$mortality == "false") &
                       !(stage_5_data$treatment == 3 & stage_5_data$mortality == "true"), ]
...
ggsave("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/paper/glme/glme_exp4.svg", 
