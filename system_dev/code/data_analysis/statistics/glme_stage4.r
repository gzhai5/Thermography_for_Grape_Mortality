...
# Load your data
data <- read.csv("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/statistics/csv/stat_all_data_noabnormal_extend_mean_normalization_pca_round_4.csv")
...
# ---- Development Stage 4 ----
cat("Running Gamma model for Development Stage 4...\n")
stage_4_data <- data[data$dev_stage == "4", ]

# Apply filtering to exclude specified conditions
stage_4_data <- stage_4_data[!(stage_4_data$treatment == 1 & stage_4_data$mortality == "false") &
                       !(stage_4_data$treatment == 2 & stage_4_data$mortality == "true"), ]
...
ggsave("/Users/mud/Desktop/Thermography_for_Grape_Mortality/code/data_analysis/paper/glme/glme_exp3.svg", 
