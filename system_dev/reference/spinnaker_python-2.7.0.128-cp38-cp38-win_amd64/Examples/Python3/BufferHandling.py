    ...
    try:
        ...
        for x in range (0, 4):
            ...
            try:
                ...
                if handling_mode_entry.GetSymbolic() == 'NewestOnly' or handling_mode_entry.GetSymbolic() == 'OldestFirstOverwrite':
                    print('Error should occur when grabbing image 1 with handling mode set to NewestOnly or OldestFirstOverwrite')
                result = False
